...
main.obj: ../main.c $(GEN_OPTS) | $(GEN_HDRS)
	...
	"D:/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 -me --include_path="D:/Library_/TIVA/TivaWare_C_Series-2.1.4.178/driverlib" --include_path="D:/GitRepository/TivaC/TEST_PCB/TEST_GPIO_TIMER_PWM_SW" --include_path="D:/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include" --define=ccs="ccs" --define=PART_TM4C123BE6PM -g --gcc --diag_warning=225 --diag_wrap=off --display_error_number --abi=eabi --preproc_with_compile --preproc_dependency="main.d_raw" $(GEN_OPTS__FLAG) "$<"
